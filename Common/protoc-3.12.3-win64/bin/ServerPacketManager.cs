...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.CFileTransfer, MakePacket<C_FileTransfer>);
		_handler.Add((ushort)MsgId.CFileTransfer, PacketHandler.C_FileTransferHandler);		
		_onRecv.Add((ushort)MsgId.CPackageTransfer, MakePacket<C_PackageTransfer>);
		_handler.Add((ushort)MsgId.CPackageTransfer, PacketHandler.C_PackageTransferHandler);		
